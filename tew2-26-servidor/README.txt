...
a persistence unit "tew1_26PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "tew1_26/pom.xml":
...
artifact ("tew1_26.war") is already built. You can build
